                ...
                (e.useBlobBuilder = (function () {
                    ...
                    (e.useArrayBufferView =
                        ...
                        (function () {
                            try {
                                return (
                                    0 === new Blob([new Uint8Array([])]).size
                                );
                            } catch (e) {
                                return !0;
                            }
                ...
                function i(e, r) {
                    ...
                    if (t.mediaDevices) {
                        ...
                        if (
                            ...
                            var d = t.mediaDevices.getUserMedia.bind(
                                t.mediaDevices
                            );
                                      ...
                                      function (a) {
                                          return i(a).then(function (i) {
                                              ...
                                              return (
                                                  ...
                                                  t &&
                                                      (a.video.mandatory.maxWidth =
                                                          t),
                                                  o &&
                                                      (a.video.mandatory.maxHeight =
                                                          o),
                    ...
                    if (
                        ...
                        if (!("getStats" in t.RTCRtpSender.prototype)) {
                            ...
                            n &&
                                ...
                                (t.RTCRtpSender.prototype.getStats =
                                    function () {
                                        var t = this;
                                        return this._pc
                                            .getStats()
                                            .then(function (r) {
                                                return e.filterStats(
                                                    r,
                                                    t.track,
                                                    !0
                                                );
                        ...
                        if (!("getStats" in t.RTCRtpReceiver.prototype)) {
                            ...
                            i &&
                                ...
                                (t.RTCRtpReceiver.prototype.getStats =
                                    function () {
                                        var t = this;
                                        return this._pc
                                            .getStats()
                        ...
                        if (
                            ...
                            t.RTCPeerConnection.prototype.getStats =
                                function () {
                                    if (
                                        arguments.length > 0 &&
                        ...
                        function (e) {
                            ...
                            if (
                                !(
                                    ...
                                    (t.getConfiguration &&
                                        "plan-b" ===
                                            t.getConfiguration().sdpSemantics)
                                ) ||
            ...
            function (require, module, exports) {
                ...
                (r.localCName = r.generateIdentifier()),
                    ...
                    (r.getCryptoParameters = function (e, t) {
                        return r
                            .matchPrefix(e + t, "a=crypto:")
                            .map(r.parseCryptoLine);
                    }),
            ...
            function (require, module, exports) {
                ...
                module.exports = function (c, d) {
                    function p(e, t) {
                        t.addTrack(e),
                            t.dispatchEvent(
                                new c.MediaStreamTrackEvent("addtrack", {
                                    track: e,
                                })
                            );
                    }
                    ...
                    Object.defineProperty(f.prototype, "localDescription", {
                                ...
                                (this.transceivers[e].bufferCandidates =
                                    function (t) {
                                        var a =
                                            !t.candidate ||
                                            0 ===
                                                Object.keys(t.candidate).length;
                                        (n.state = a
                                            ? "completed"
                                            : "gathering"),
                                            null !==
                        ...
                        (f.prototype._disposeIceAndDtlsTransports = function (
                            e
                        ) {
                        ...
                        (f.prototype.setLocalDescription = function (t) {
                            ...
                            if ("offer" === t.type)
                                ...
                                (r = e.splitSections(s._remoteDescription.sdp)),
                                    (n = r.shift());
                                var c =
                                    e.matchPrefix(n, "a=ice-lite").length > 0;
                                r.forEach(function (t, r) {
                        ...
                        (f.prototype.setRemoteDescription = function (t) {
                            ...
                            var f = [],
                                ...
                                m =
                                    e.matchPrefix(v, "a=group:BUNDLE ").length >
                                    0;
                            r.usingBundle = m;
                                ...
                                u.forEach(function (i, o) {
                                    ...
                                    if (
                                        ...
                                        if (
                                            ...
                                            if ("answer" === t.type && !g) {
                                                (P = (C = r.transceivers[o])
                                                    .iceGatherer),
                                                    (w = C.iceTransport),
                                                    (R = C.dtlsTransport),
                                                    (_ = C.rtpReceiver),
                                                    (k =
                                                        C.sendEncodingParameters),
                                            ...
                                            ((C =
                                                r.transceivers[o] ||
                                                r._createTransceiver(u)).mid =
                                                E),
                                                C.iceGatherer ||
                                                    (C.iceGatherer =
                                                        r._createIceGatherer(
                                                            o,
                                                            m
                                                        )),
                                                j.length &&
                                                    "new" ===
                                                        C.iceTransport.state &&
                                                    (!G || (m && 0 !== o)
                                                        ? j.forEach(function (
                                                              e
                                                          ) {
                                                        ...
                                                        : C.iceTransport.setRemoteCandidates(
                                                              j
                                                          )),
                                                (x =
                                                    c.RTCRtpReceiver.getCapabilities(
                                                        u
                                                    )),
                                                d < 15019 &&
                                            ...
                                            if (
                                                ...
                                                if (
                                                    ...
                                                    (D = _.track),
                                                        ...
                                                        N &&
                                                            (p(D, N),
                                                            C.associatedRemoteMediaStreams.push(
                                                                N
                                                            )),
                                                        f.push([D, _, N]);
                                            } else
                ...
                function n(t, o) {
                    ...
                    if (
                        ...
                        var a = function (e, t, o) {
                            ...
                            s = n.mediaDevices.getUserMedia.bind(
                                n.mediaDevices
                            );
                        if (
            ...
            function (require, module, exports) {
                ...
                function y(e) {
                    if ("object" === a(e) && e.RTCRtpSender) {
                        ...
                        t &&
                            (e.RTCRtpSender.prototype.getParameters =
                                function () {
                ...
                function m(e) {
                    if ("object" === a(e) && e.RTCPeerConnection) {
                        ...
                        e.RTCPeerConnection.prototype.createAnswer =
                            function () {
                                var e = arguments,
                                    n = this;
                                return this.setParametersPromises &&
                                        ...
                                        return (
                                            n &&
                                                n.forEach(function (e) {
                                                    r._localStreams
                                                        ? r._localStreams.includes(
                                                              e
                                                          ) ||
                                                          r._localStreams.push(
                                                              e
                                                          )
                                                        : (r._localStreams = [
                                                              e,
                                                ...
                                                e.streams.forEach(function (e) {
                                                    if (
                                                        (t._remoteStreams ||
                                                            (t._remoteStreams =
                                                                []),
                                                        !t._remoteStreams.includes(
                                                            e
                                                        ))
                                                    ) {
                                                        t._remoteStreams.push(
                                                            e
                                                        );
                                                        var r = new Event(
                                                            "addstream"
                ...
                exports.Supports = new ((function () {
                    ...
                    return (
                        ...
                        (e.prototype.isUnifiedPlanSupported = function () {
                            ...
                            var o = !1;
                            try {
                                (e = new RTCPeerConnection()).addTransceiver(
                                    "audio"
                                ),
                                    (o = !0);
                            } catch (s) {
                    ...
                    function e() {
                        (this.CLOUD_HOST = "0.peerjs.com"),
                            ...
                            (this.supports = (function () {
                                ...
                                try {
                                    (e = new RTCPeerConnection(i)),
                                        (t.audioVideo = !0);
                                    var r = void 0;
                                    try {
                                        (r = e.createDataChannel(
                                            "_PEERJSTEST",
                                            { ordered: !0 }
                                        )),
                                            (t.data = !0),
                ...
                Object.create &&
                    ...
                    (i.prototype.emit = function (e, n, r, o, s, i) {
                        ...
                        if (a.fn) {
                            switch (
                                (a.once &&
                                    this.removeListener(e, a.fn, void 0, !0),
                                l)
                            ) {
                                case 1:
                                ...
                                case 6:
                                    return (
                                        a.fn.call(a.context, n, r, o, s, i), !0
                                    );
                            }
                                ...
                                !this._socket &&
                                    ...
                                    (this._socket.onclose = function (e) {
                                        n._disconnected ||
                                            ...
                                            (n._disconnected = !0),
                                            n.emit(
                                                c.SocketEventType.Disconnected
                                            ));
                                    }),
                ...
                var i = require("./util"),
                    ...
                    a = (function () {
                        ...
                        return (
                                ...
                                r.default.log("Listening for ICE candidates."),
                                    (e.onicecandidate = function (e) {
                                        e.candidate &&
                                            e.candidate.candidate &&
                                            (r.default.log(
                                                "Received ICE candidates for " +
                                                    t +
                                                    ":",
                                                e.candidate
                                            ),
                                            s.socket.send({
                                                type: c.ServerMessageType
                                                    .Candidate,
                                                payload: {
                            ...
                            (o.prototype._addTracksToConnection = function (
                                e,
                                n
                            ) {
                                if (
                            ...
                            (o.prototype._addStreamToMediaConnection =
                                function (e, n) {
                                    r.default.log(
                                        "add stream " +
                                            e.id +
                            ...
                            (l.prototype.handleMessage = function (e) {
                                ...
                                switch (e.type) {
                                    ...
                                    case s.ServerMessageType.Candidate:
                                        this._negotiator.handleCandidate(
                                            o.candidate
                                        );
                                        break;
                                    default:
                            ...
                            (l.prototype.answer = function (e, r) {
                                ...
                                if (
                                    ...
                                    (this._localStream = e),
                                        r &&
                                            r.sdpTransform &&
                                            (this.options.sdpTransform =
                                                r.sdpTransform),
                                        this._negotiator.startConnection(
                                            t(t({}, this.options._payload), {
                                                _stream: e,
                                            })
                                        );
                            ...
                            (s.prototype._handleDataMessage = function (e) {
                                ...
                                if (
                                    ...
                                    if (r === ArrayBuffer) s = i.util.unpack(o);
                                        ...
                                        var u =
                                            i.util.binaryStringToArrayBuffer(o);
                                        s = i.util.unpack(u);
                                    }
                                } else
                                    this.serialization ===
                                        a.SerializationType.JSON &&
                                        (s = this.parse(o));
                                s.__peerData
                                    ? this._handleChunk(s)
                    ...
                    f = (function (o) {
                        ...
                        return (
                            ...
                            (i.prototype._createServerConnection = function () {
                                ...
                                return (
                                    ...
                                    t.on(d.SocketEventType.Error, function (t) {
                                        e._abort(
                                            d.PeerErrorType.SocketError,
                                            t
                                        );
                                    }),
                                    t.on(
                                        d.SocketEventType.Disconnected,
                                        function () {
                                            e.disconnected ||
                                                (e.emitError(
                                ...
                                switch (o) {
                                    case d.ServerMessageType.Open:
                                        (this._lastServerId = this.id),
                                            (this._open = !0),
                                            this.emit(
                                                d.PeerEventType.Open,
                                                this.id
                                            );
                                        break;
                                    case d.ServerMessageType.Error:
                                        this._abort(
                                            d.PeerErrorType.ServerError,
                                            i.msg
                                        );
                                        break;
                                    ...
                                    case d.ServerMessageType.Offer:
                                        ...
                                        if (
                                            ...
                                            (_ = new l.MediaConnection(
                                                ...
                                                this.emit(
                                                    d.PeerEventType.Call,
                                                    _
                                                );
                                        else {
                                            if (
                                                i.type !== d.ConnectionType.Data
                                            )
                            ...
                            (i.prototype._cleanup = function () {
                                ...
                                try {
                                    for (
                                        var r = n(this._connections.keys()),
                                            o = r.next();
                                        !o.done;
                                        o = r.next()
                                    ) {
